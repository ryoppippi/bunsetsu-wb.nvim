local M = {}
vim.api.nvim_create_user_command("BunsetsuCWORD", function()
...
M.getCWORD = function(pos)
  ...
  if token_info == nil then
    ...
    for _, token in ipairs(result) do
      local total_len_with_token = total_len + #token
...
M.w = function()
  ...
  local col = r.col
  vim.fn.cursor(current_lnum, col)
  return r
end
